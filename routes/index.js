...
router.get('/api/version', (req, res) => {
    res.json({ version: '5.1' }); // Substitua pela versão mais recente
  });
  
  router.get('/api/update/:version', (req, res) => {
    const version = req.params.version;
    const filePath = path.join(__dirname, `./updates/InfoComputadores_${version}.exe`); // Caminho para o instalador
